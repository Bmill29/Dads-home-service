...
export const BUSINESS = {
  ...
  serviceArea: "Western New York",
  serviceAreaTowns:
    "Buffalo, Amherst, Clarence, Lancaster, Orchard Park, West Seneca, Hamburg & Cheektowaga",
  yearsInBusiness: 3,
...
export const TRUST_POINTS = [
  { label: "Licensed & Insured", detail: "Fully licensed and insured for every job, big or small." },
  {
    ...
    detail: "Three years of dependable craftsmanship across WNY.",
  },
  {
...
export const SERVICES = [
  ...
  },
  {
    ...
    name: "Siding & Roofing",
    description:
      "Weather-tight exteriors that hold up to a WNY winter — siding replacement, repair, and roofing.",
...
export const GALLERY_PROJECTS = [
  {
    ...
    before: img("1556912167-f556f1f39fdf"),
    after: img("1616486338812-3dadae4b4ace"),
  },
  {
    id: "g2",
    ...
    before: img("1552321554-5fefe8c9ef14"),
    after: img("1584622781564-1d987f7333c1"),
  },
  {
    id: "g3",
    ...
    before: img("1600585154340-be6161a56a0c"),
    after: img("1600566752355-35792bedcfea"),
  },
  {
    id: "g4",
    ...
    before: img("1581591524425-c7e0978865fc"),
    after: img("1581858726788-75bc0f6a952d"),
  },
  {
    id: "g5",
    ...
    before: img("1541123437800-1bb1317badc2"),
    after: img("1512917774080-9991f1c4c750"),
  },
  {
    id: "g6",
    ...
    description: "Full tear-off roof and siding replacement ahead of a rough WNY winter.",
    before: img("1568605114967-8130f3a36994"),
    after: img("1600210491892-03d54c0aaf87"),
  },
  {
    id: "g7",
    ...
    before: img("1521783593447-5702b9bfd267"),
    after: img("1493809842364-78817add7ffb"),
  },
  {
    id: "g8",
    ...
    before: img("1592194996308-7b43878e84a6"),
    after: img("1600585152220-90363fe7e115"),
  },
];
...
export const INITIAL_JOBS = [
  {
    id: "J-1001",
    customer: { name: "Sarah Thompson", email: "sarah.thompson@example.com", phone: "716-555-0148" },
    category: "kitchens",
    description:
  ...
  {
    id: "J-1004",
    customer: { name: "Mike Delgado", email: "mike.delgado@example.com", phone: "716-555-0212" },
    category: "basements",
    description:
  ...
  {
    id: "J-1005",
    customer: { name: "Jennifer Ruiz", email: "jennifer.ruiz@example.com", phone: "716-555-0334" },
    category: "flooring",
    description:
  ...
  {
    id: "J-1006",
    customer: { name: "Tom Whitfield", email: "tom.whitfield@example.com", phone: "716-555-0459" },
    category: "siding-roofing",
    description:
  ...
  {
    id: "J-1007",
    customer: { name: "Carlos Mendez", email: "carlos.mendez@example.com", phone: "716-555-0587" },
    category: "additions",
    description:
  ...
  {
    id: "J-1008",
    customer: { name: "Emily Carter", email: "emily.carter@example.com", phone: "716-555-0621" },
    category: "general-repairs",
    description:
  ...
  {
    id: "J-1009",
    customer: { name: "David Kim", email: "david.kim@example.com", phone: "716-555-0763" },
    category: "kitchens",
    description:
